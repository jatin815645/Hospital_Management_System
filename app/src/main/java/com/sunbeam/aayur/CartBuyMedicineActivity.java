...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst = findViewById(R.id.listViewCMB);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CartBuyMedicineActivity.this, BuyMedicinActivity.class));
            }
        });
        ...
        btnCheckOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(CartBuyMedicineActivity.this, BuyMedicinBookActivity.class);
                it.putExtra("price",String.valueOf(totalAmount).toString());
